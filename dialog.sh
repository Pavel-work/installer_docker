...
choices=$(dialog --stdout \
                 ...
                 --checklist "Отметьте нужные сервисы (пробел - выбор/снятие):" 25 108 12 \
...
# ==========================================
# 6. Готово + Информация (28x108) - было 31x120
# ==========================================
